...
<head>
  ...
  <link rel="stylesheet" href="style/style_index.css" type="text/css"> </head>
...
<body>
  ...
  <div class="py-5 bg-dark text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-9">
          <p class="lead">뉴스 레터를 받아 보시려면 여기에 이메일을 적어 주시면 다양한 정보를 드리겠습니다.</p>
      ...
      <div class="row">
        <div class="col-md-12 mt-3 text-center">
          <p>© Copyright 2017b bus - All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
