    ...
    <div class="container" style="margin-top: 60px;">
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        <a class="ml-3 btn navbar-btn btn-dark border border-warning" href="#">Reservation</a><i class="fa fa-stack-exchange fa-fw fa-3x d-inline pull-right bg-dark text-white"></i> 
         <a class="ml-3 btn navbar-btn btn-dark border border-warning" href="href="${pageContext.request.contextPath}/payment_check.do">예약 확인</a><i class="fa fa-stack-exchange fa-fw fa-3x d-inline pull-right bg-dark text-white"></i>
        </div>
    </div>
  </nav>
  <div class="py-5">
