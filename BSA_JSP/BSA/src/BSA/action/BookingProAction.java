	...
	public String requestPro(HttpServletRequest req, HttpServletResponse resp) throws Throwable {
		...
		if(req.getParameter("where_trip").equals("왕복")) {
			if(req.getParameter("where_from").equals("#")) {
				...
				return "/JSP/Booking_round.jsp";
			}
			if(req.getParameter("where_to").equals("#")) {
				req.setAttribute("where_to_check", 1);
				return "/JSP/Booking_round.jsp";
			}
			...
			if(req.getParameter("arrival_airline_name").equals("#") || req.getParameter("start_airline_name").equals("1")) {
			...
			if(req.getParameter("start_date").equals("")) {
				req.setAttribute("start_date_check", 1);
				return "/JSP/Booking_round.jsp";
			}
